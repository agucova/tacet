//! Benchmark comparison infrastructure for timing-oracle.
//!
//! This crate provides tools for comparing timing-oracle against other
...
//!
//! // Output results
//! println!("{}", timing_oracle_bench::output::to_markdown(&results));
//! ```
//!
//! # Legacy API
//!
