...
//!
//! This module provides a unified interface for comparing timing-oracle against
//! other timing side-channel detection tools (dudect, RTLF, etc.).
//!
//! # Design
//!
//! Each tool gets data in its preferred format:
//! - timing-oracle: interleaved samples (exploits temporal correlations)
...
/// but still applies timing-oracle's superior statistical methodology.
#[derive(Debug, Clone)]
...
impl ToolAdapter for TimingOracleAdapter {
    ...
    // Note: timing-oracle currently uses blocked data for analyze_raw_samples.
...
///
/// For rigorous analysis, prefer RTLF, SILENT, or timing-oracle which use
...
mod tests {
    ...
    #[test]
    fn test_timing_oracle_adapter_null() {
    ...
    #[test]
    fn test_timing_oracle_adapter_shift() {
        let config = SyntheticConfig {
