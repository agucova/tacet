/**
 * @file simple.c
 * @brief Basic timing-oracle usage example using one-shot analysis.
 *
 ...
 *   ./crates/timing-oracle-c/examples/simple
 */
...
int main(void) {
    printf("timing-oracle simple example (one-shot analysis)\n");
