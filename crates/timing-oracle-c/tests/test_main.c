/**
 * @file test_main.c
 * @brief CMocka test runner for timing-oracle C API tests.
 *
...
static void print_usage(const char *prog_name) {
    ...
    printf("\n");
    printf("Run timing-oracle C API tests.\n");
    printf("\n");
    printf("Test groups:\n");
...
int main(int argc, char **argv) {
    ...
    if (argc == 1) {
        ...
        for (int i = 1; i < argc; i++) {
            if (strcmp(argv[i], "-h") == 0 || strcmp(argv[i], "--help") == 0) {
                ...
                printf("timing-oracle version: %s\n", to_version());
                return 0;
    ...
    /* Print header */
    printf("========================================\n");
    printf("  timing-oracle C API Test Suite\n");
