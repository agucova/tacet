...
use tacet_bench::adapters::{RtlfAdapter, RtlfNativeAdapter, ToolAdapter};
...
fn main() {
    ...
    println!(
        "  Agreement: {} | Expected: No detection",
    ...
    println!(
        "  Native FPR: {}/20 = {:.0}%",
        native_detections,
        native_detections as f64 / 20.0 * 100.0
    );
    println!(
        "  R FPR:      {}/20 = {:.0}%",
        r_detections,
        r_detections as f64 / 20.0 * 100.0
    );
