...
//
// This example demonstrates how to use tacet to test an operation
// for timing side channels.
//
// Build the Rust library first:
//   cargo build -p tacet-uniffi --release
//
