...
fn exp_comprehensive_shape_analysis() {
    ...
    eprintln!("{}", timing_oracle::output::format_outcome(&outcome_2a));
    ...
    if let (Some(cta), Some(ctb)) = (ct_same_a, ct_same_b) {
        ...
        eprintln!("{}", timing_oracle::output::format_outcome(&outcome_2b));
    } else {
    ...
    eprintln!("{}", timing_oracle::output::format_outcome(&outcome_2c));
