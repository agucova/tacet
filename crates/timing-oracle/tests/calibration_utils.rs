...
impl CalibrationConfig {
    ...
    pub fn from_env(test_name: &str) -> Self {
        ...
        let (seed, seed_source) = if let Ok(seed_str) = std::env::var("CALIBRATION_SEED") {
            ...
            let seed = fnv1a_64(format!("timing-oracle:{}", test_name).as_bytes());
...
mod tests {
    ...
    fn test_fnv1a_64_deterministic() {
        let hash1 = fnv1a_64(b"timing-oracle:test_name");
        let hash2 = fnv1a_64(b"timing-oracle:test_name");
        assert_eq!(hash1, hash2);
    }

    #[test]
    fn test_fnv1a_64_different_inputs() {
        let hash1 = fnv1a_64(b"timing-oracle:test1");
        let hash2 = fnv1a_64(b"timing-oracle:test2");
