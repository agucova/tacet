...
// Custom threshold
timing_oracle_t* oracle = timing_oracle_for_attacker_custom(500.0);
```
</TabItem>
<TabItem label="Go">
```go
// Preset
oracle := timingoracle.ForAttacker(timingoracle.AdjacentNetwork)

// Custom threshold
oracle := timingoracle.ForAttackerCustom(500.0)
```
</TabItem>
</Tabs>
