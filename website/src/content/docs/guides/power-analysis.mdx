...
The statistical engine is shared with timing analysis (see [Power Module Specification](/reference/specification-power)), extended to handle multidimensional power features extracted from trace partitioning.
...
- **[Power Module Specification](/reference/specification-power):** Normative power module specification
- **[Main Specification](/reference/specification):** Core statistical methodology shared with power analysis
