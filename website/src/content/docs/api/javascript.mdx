...
This document covers the JavaScript/TypeScript bindings for timing-oracle via NAPI-RS.
...
```typescript
import { TimingOracle, AttackerModel } from '@timing-oracle/js';
...
```typescript
import { collectSamples } from '@timing-oracle/js';
...
```typescript
import { analyze, calibrateTimer, configAdjacentNetwork } from '@timing-oracle/js';
